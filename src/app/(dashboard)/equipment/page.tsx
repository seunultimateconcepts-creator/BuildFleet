                  ...
                  <tr key={item.id} className="hover:bg-amber-50/30 transition-colors group">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <Link href={`/equipment/${item.code}?tab=transfers`} title="Transfer history — dispatched / approved / received"
                          className="text-xs px-2.5 py-1.5 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 font-medium whitespace-nowrap">
                          🕒 History
                        </Link>
                        {canSeeStatusBtn && (
          ...
          {loading ? (
            ...
            <div key={item.id}
              ...
              <div className="flex gap-2 mt-4 pt-4 border-t border-slate-100">
                ...
                <Link href={`/equipment/${item.code}?tab=transfers`} title="Transfer history"
                  className="text-xs px-3 py-2 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 font-medium">
                  🕒
                </Link>
                {canSeeStatusBtn && (
                  <button onClick={() => setStatusItem(item)}
