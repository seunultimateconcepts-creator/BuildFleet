...
const navItems = [
  ...
  {
    label: "Material Requisition", icon: ClipboardList, badge: "NEW",
    roles: ["super_admin","plant_manager","plant_engineer","plant_admin","plant_officer","site_supervisor",
            "plant_clerk","store_officer","store_manager","store_supervisor","procurement_officer","procurement_manager",
            "plant_director","executive"],
    children: [
      { label: "SRO", href: "/sro", icon: ClipboardList },
      { label: "LRO", href: "/lro", icon: ClipboardList },
    ],
  },
